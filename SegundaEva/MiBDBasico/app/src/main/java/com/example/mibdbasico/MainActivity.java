...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickEliminar(View v) {
        ...
        //dbw.close(); // ojo no es necesario cerrar la base de datos,no se vera appinspector
    }
    ...
    public void clickConsultar(View v) {
       ...
       // dbr.close(); //no se vera appinspector
    }
    ...
    public void clickActualizar(View v) {
        ...
        dbw.execSQL(sql); // Ejecuta sentencia sql sin más.
       // dbw.close(); // no es necesario cerrar la base de datos, no se vera appinspector
    }
