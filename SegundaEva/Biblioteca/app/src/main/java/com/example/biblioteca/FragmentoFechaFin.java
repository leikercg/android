...
public class FragmentoFechaFin extends DialogFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public void onDateSet(DatePicker datePicker, int i, int i1, int i2) { // evento que estaclece la fecha
        ...
        fecha.pasarFechaFin(i,i1,i2);
    }

    public interface Fecha{ // Interfaz para pasar los datos
        public void pasarFechaFin(int año,int mes, int dia); // Metodo para pasar los datos
    }
}
